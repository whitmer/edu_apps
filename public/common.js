...
(function() {
  ...
  Handlebars.registerHelper('stars', function(context, options) {
    ...
    var res = "<span title='" + context + " star" + (context == 1 ? "" : "s") + "' class='stars star" + context_str + "'>";
...
function program23(depth0,data) {
  ...
  tmp1.hash = {};
  tmp1.fn = tmp1;
  tmp1.inverse = self.program(35, program35, data);
  stack1 = stack2.call(depth0, stack1, tmp1);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        ";
  return buffer;}
function program24(depth0,data) {
  ...
  tmp1.hash = {};
  tmp1.fn = tmp1;
  tmp1.inverse = self.program(32, program32, data);
